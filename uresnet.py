...
class uresnet(ssnet_base):
    ...
    def __init__(self, data_dims, label_dims, num_class, num_strides=5, base_num_outputs=16, debug=False):
        super(uresnet,self).__init__(data_dims=data_dims, 
...
if __name__ == '__main__':
    ...
    net = uresnet(data_dims=labeldims,
                  label_dims=label_dims,
                  num_class=NUM_CLASS,
                  debug=True)
